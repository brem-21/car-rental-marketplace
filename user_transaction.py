...
daily_transactions = (
    rentals_df.withColumn("rental_date", date_format("rental_start_time", "yyyy-MM-dd"))
    .groupBy("rental_date")
    .agg(
...
total_rental_hours_per_user = (
    rental_duration.groupBy("user_id")
...
avg_transaction_value.write.parquet(
    output_path + "avg_transaction_value", mode="overwrite"
)
...
total_rental_hours_per_user.write.parquet(
    output_path + "total_rental_hours_per_user", mode="overwrite"
)
